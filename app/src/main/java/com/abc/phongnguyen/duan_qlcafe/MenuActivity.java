...
import com.abc.phongnguyen.duan_qlcafe.adapter.TeaMenuAdapter;
...
public class MenuActivity extends AppCompatActivity implements ImageDownloader.DelayerCallback {
    ...
    @Override
    public void onDone(ArrayList<Cafe> teas) {
        ...
        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Cafe item = (Cafe) adapterView.getItemAtPosition(position);
