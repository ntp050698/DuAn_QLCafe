package com.abc.phongnguyen.duan_qlcafe.adapter;
...
import com.abc.phongnguyen.duan_qlcafe.R;
import com.abc.phongnguyen.duan_qlcafe.model.Cafe;

import java.util.ArrayList;


public class TeaMenuAdapter extends ArrayAdapter<Cafe> {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        Cafe currentTea = getItem(position);
